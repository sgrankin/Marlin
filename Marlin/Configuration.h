...
#define STRING_CONFIG_H_AUTHOR "(sgrankin, MakerGear M2E)" // Original author or contributor.
...
#define CUSTOM_MACHINE_NAME "M2E"
...
//#define HOTEND_OFFSET_X { 0.0, 31.25 } // (mm) relative X-offset for each nozzle
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Use separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    // M2E
    // Generated with: M303 C5 D0 E-1 S70
...
#define PIDTEMPBED
  ...
  //MakerGear M2 24v Aluminum Heatbed w/ MIC6 Plate
  //Generated with M303 C5 D0 E<0 or 1> S<200 or your filament temperature>
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 44.44*2, 44.44*2, 1007.7, 471.5 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -36.51, 0, -19.1 }
...
#define PROBE_OFFSET_ZMAX -0.1   // (mm)
...
#define Z_CLEARANCE_FOR_HOMING  30    // (mm) Minimal Z height before homing (G28) for Z clearance above the bed, clamps, ...

...
//#define HOTEND_OFFSET_X {0.0, 31.25} // (in mm) for each extruder, offset of the hotend on the X axis
 ...
 *    (0,0)
 */
#define X_PROBE_OFFSET_FROM_EXTRUDER -36.51  // X offset: -left  +right  [of the nozzle]
#define Y_PROBE_OFFSET_FROM_EXTRUDER 0  // Y offset: -front +behind [the nozzle]
#define Z_PROBE_OFFSET_FROM_EXTRUDER -19.1   // Z offset: -below +above  [the nozzle]
